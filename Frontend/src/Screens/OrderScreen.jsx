...
import axiosInstance from '../axiosInstance'; // Replace axios with your instance import
...
function OrderScreen() {
    ...
    const successPaymentHandler = async (paymentResult) => {
        try {
            ...
            await axiosInstance.put(`/api/orders/${orderId}/pay/`, paymentResult, config);
            setLoadingPay(false);
    ...
    const deliverHandler = async () => {
        try {
            ...
            await axiosInstance.put(`/api/orders/${orderId}/deliver/`, {}, config);
